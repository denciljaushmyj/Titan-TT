...
from adminportal.performance_log_viewer import performance_logs_view
from adminportal.image_performance_logging import serve_logged_media, serve_logged_static
...
_URLCONF_LOAD_STARTED = perf_counter()
...
emit_urlconf_loaded(duration_ms(_URLCONF_LOAD_STARTED), urlpattern_count=len(urlpatterns))
